...
import { Plus, Pencil, AlertTriangle, ShoppingCart, Trash2, X, Check, DollarSign } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-sans font-semibold text-neutral-900">Products & POS Cart</h1>
        ...
        <div className="space-y-6">
          ...
          {cartItems.length > 0 && (
            <div className="space-y-4 border-t border-neutral-200 pt-4">
              ...
              >
                {checkingOut ? <LoadingSpinner /> : <DollarSign size={16} />}
